...
const Banner = () => {
  return (
    <div className="w-full bg-white">
      {/* Container restricted to 1280px */}
      <div className="max-w-[1280px] mx-auto mt-12 md:mt-[85px]">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          {/* Left Content */}
          <div className="flex-1 space-y-6 text-left order-2 lg:order-1">
            {/* Badge */}
            <div className="inline-flex items-center rounded-full bg-purple-50 px-3 py-1 text-sm font-medium text-purple-600 ring-1 ring-inset ring-purple-200">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              ...
              <button className="rounded-full bg-gradient-to-r from-[#4F39F6] to-[#9514FA] px-8 py-4 text-sm font-bold text-white transition hover:opacity-90 shadow-lg">
                Explore Products
              </button>

              {/* Gradient Border & Gradient Text Button */}
              <div className="group relative p-[2px] rounded-full bg-gradient-to-r from-[#4F39F6] to-[#9514FA]">
                <button className="flex items-center gap-2 rounded-full bg-white px-8 py-[14px] transition group-hover:bg-transparent">
                  <FaPlayCircle
                    size={20}
          ...
          <div className="flex-1 w-full order-1 lg:order-2">
            <div className="relative mx-auto max-w-[500px] lg:max-w-none">
              <img
                ...
                className="w-[590px] max-h-[600px] rounded-2xl"
              />
            </div>
          </div>
        </div>
